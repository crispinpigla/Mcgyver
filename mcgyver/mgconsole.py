""" Ce fichier gère l'affichage du jeux en mode console """
...
class ModeConsole:
    ...
    """ Cette classe est celle du mode console du jeu """
    ...
    def start(self, mg0, liste_objets_aramass, gardien0, sortie0, plateau0):
        ...
        while mg0.position != sortie0.position:
            self.draw_console(mg0.position, liste_objets_aramass,
                              sortie0.position, plateau0)
            direction_input = input("Déplacer McGyver !! \n\n " + config.MOUVEMENT_GAUCHE +
                                    " : vers la gauche\n " + config.MOUVEMENT_DROITE +
                                    " : vers la droite\n " + config.MOUVEMENT_BAS +
                                    " : vers le bas\n " + config.MOUVEMENT_HAUT +
                                    " : vers le haut\n\n ")
